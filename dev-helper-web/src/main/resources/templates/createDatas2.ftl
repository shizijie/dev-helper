...
<body>
    ...
    <form id="dbForm" class="form-horizontal">
        <div class="form-group">
            <label class="col-sm-2 control-label" for="url">url（ip:port）</label>
            <div class="col-sm-8">
        ...
        <div class="form-group">
            <label class="col-sm-2 control-label" for="database">database（库名）</label>
            <div class="col-sm-8">
                <input type="text" class="form-control" id="database" name="database" placeholder="username" required>
            </div>
        </div>
